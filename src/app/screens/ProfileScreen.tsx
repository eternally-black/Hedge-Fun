...
export function ProfileScreen({ me, api, onRefresh, onHistory, onLogout, onToast }: { me: Me | null; api: Api; onRefresh: () => Promise<void>; onHistory: () => void; onLogout: () => void; onToast: (msg: string) => void }) {
  ...
  return (
    <div className="hf-scroll" style={{ position: "absolute", inset: 0, overflowY: "auto", padding: "4px 16px 20px" }}>
      ...
      <RealModeCard me={me} api={api} onRefresh={onRefresh} onToast={onToast} />
