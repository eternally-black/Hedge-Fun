...
async function main() {
  ...
  // /api/real/exit-quote is NOT imported here: it pulls in src/lib/fees.ts, whose SDK root tsx
  // cannot resolve (see the note at the top of that file). Same reason /api/real/intent is absent.
