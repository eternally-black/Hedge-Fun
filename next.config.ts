    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=()" },
          {
            ...
            value:
              "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; connect-src 'self' https://auth.privy.io https://*.privy.io https://clob.polymarket.com https://gamma-api.polymarket.com https://bridge.polymarket.com https://polymarket.com https://relayer-v2.polymarket.com https://polygon-bor-rpc.publicnode.com wss://*.privy.io; frame-src https://auth.privy.io https://*.privy.io; frame-ancestors 'none'",
          },
        ],
      },
    ];
